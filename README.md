...
- Phase 4D.4 private metrics, self-hosted Grafana pipeline, source-reliability, and governed-release
  dashboards, correlation IDs, heartbeat, and alerts: implemented
