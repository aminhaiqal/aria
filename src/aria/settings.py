...
REST_FRAMEWORK = {
    ...
    "DEFAULT_THROTTLE_RATES": {
        ...
        "reader_chat": os.getenv("ARIA_READER_CHAT_RATE", "20/min"),
    },
}
...
OPENROUTER_HTTP_REFERER = os.getenv("OPENROUTER_HTTP_REFERER", "https://aria.axelyn.com")
OPENROUTER_APP_TITLE = os.getenv("OPENROUTER_APP_TITLE", "ARIA")
OPENROUTER_ZDR = env_bool("OPENROUTER_ZDR", True)
OPENROUTER_DATA_COLLECTION = os.getenv("OPENROUTER_DATA_COLLECTION", "deny").strip().lower()
if OPENROUTER_DATA_COLLECTION not in {"", "allow", "deny"}:
    raise ImproperlyConfigured("OPENROUTER_DATA_COLLECTION must be allow, deny, or empty.")
OPENROUTER_ALLOW_PROVIDER_FALLBACKS = env_bool(
    "OPENROUTER_ALLOW_PROVIDER_FALLBACKS", True
)
OPENROUTER_TIMEOUT_SECONDS = float(os.getenv("ARIA_OPENROUTER_TIMEOUT_SECONDS", "60"))
OPENROUTER_MAX_RETRIES = int(os.getenv("ARIA_OPENROUTER_MAX_RETRIES", "3"))
...
OPENROUTER_EMBEDDING_BATCH_SIZE = int(
    os.getenv("ARIA_OPENROUTER_EMBEDDING_BATCH_SIZE", "64")
)
OPENROUTER_SUMMARY_MODEL = os.getenv(
    "ARIA_OPENROUTER_SUMMARY_MODEL", "openai/gpt-5.6-sol"
)
OPENROUTER_SUMMARY_REASONING_EFFORT = os.getenv(
    "ARIA_OPENROUTER_SUMMARY_REASONING_EFFORT", "low"
)
OPENROUTER_SUMMARY_MAX_OUTPUT_TOKENS = int(
    os.getenv("ARIA_OPENROUTER_SUMMARY_MAX_OUTPUT_TOKENS", "2000")
)
OPENROUTER_SUMMARY_MAX_ITEMS = int(os.getenv("ARIA_OPENROUTER_SUMMARY_MAX_ITEMS", "50"))
OPENROUTER_SUMMARY_MAX_CHARS_PER_ANCHOR = int(
    os.getenv("ARIA_OPENROUTER_SUMMARY_MAX_CHARS_PER_ANCHOR", "12000")
)
OPENROUTER_IMPACT_MODEL = os.getenv(
    "ARIA_OPENROUTER_IMPACT_MODEL", OPENROUTER_SUMMARY_MODEL
)
OPENROUTER_IMPACT_REASONING_EFFORT = os.getenv(
    "ARIA_OPENROUTER_IMPACT_REASONING_EFFORT", "low"
)
OPENROUTER_IMPACT_MAX_OUTPUT_TOKENS = int(
    os.getenv("ARIA_OPENROUTER_IMPACT_MAX_OUTPUT_TOKENS", "3000")
)
OPENROUTER_IMPACT_MAX_CHARS_PER_ANCHOR = int(
    os.getenv("ARIA_OPENROUTER_IMPACT_MAX_CHARS_PER_ANCHOR", "12000")
)
...
OPENROUTER_CHAT_MODEL = os.getenv("ARIA_OPENROUTER_CHAT_MODEL", OPENROUTER_SUMMARY_MODEL)
OPENROUTER_CHAT_REASONING_EFFORT = os.getenv(
    "ARIA_OPENROUTER_CHAT_REASONING_EFFORT", "low"
)
OPENROUTER_CHAT_MAX_OUTPUT_TOKENS = min(
    4000,
    max(300, int(os.getenv("ARIA_OPENROUTER_CHAT_MAX_OUTPUT_TOKENS", "1600"))),
)
READER_CHAT_MAX_QUESTION_CHARACTERS = min(
    4000,
    max(200, int(os.getenv("ARIA_READER_CHAT_MAX_QUESTION_CHARACTERS", "2000"))),
)
READER_CHAT_MAX_SOURCES = min(
    12,
    max(3, int(os.getenv("ARIA_READER_CHAT_MAX_SOURCES", "8"))),
)
READER_CHAT_CANDIDATE_LIMIT = min(
    100,
    max(READER_CHAT_MAX_SOURCES, int(os.getenv("ARIA_READER_CHAT_CANDIDATE_LIMIT", "40"))),
)
READER_CHAT_MAX_SOURCE_CHARACTERS = min(
    6000,
    max(1000, int(os.getenv("ARIA_READER_CHAT_MAX_SOURCE_CHARACTERS", "3500"))),
)
READER_CHAT_HISTORY_MESSAGES = min(
    40,
    max(2, int(os.getenv("ARIA_READER_CHAT_HISTORY_MESSAGES", "16"))),
)
READER_CHAT_HISTORY_CHARACTERS = min(
    30000,
    max(2000, int(os.getenv("ARIA_READER_CHAT_HISTORY_CHARACTERS", "12000"))),
)
